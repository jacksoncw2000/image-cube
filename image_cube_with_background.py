...
from vtkmodules.vtkCommonDataModel import vtkPlaneSource
...
def load_background_texture(img_path):
    # This function is similar to load_texture, but simplified for the background
...
plane_source.SetOrigin(-1, -1, -2)  # Place it behind the cube
plane_source.SetPoint1(1, -1, -2)
plane_source.SetPoint2(-1, 1, -2)
plane_source.Update()
...
# After adding all actors, reset the camera
